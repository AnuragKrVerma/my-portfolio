...
const Contact = () => {
  return (
    <div className="bg-black">
      <div
        className="max-w-[1000px] mx-auto flex flex-col lg:flex-row bg-black text-white/70 p-8
    rounded-lg space-y-8 lg:space-y-0 lg:space-x-8  "
      ...
      >
        <div className="flex justify-center items-center">
          <ul className="space-y-4">
            <li className="flex items-center">
              ...
              />
              <p className="text-xl">+91 XXXXX-XXXXX</p>
            </li>
        ...
        <div className="bg-white/10 p-6 rounded-xl max-w-[550px]">
          ...
          <form
            action="https://getform.io/f/bmdddlva"
            method="POST"
            className="space-y-4"
          >
            ...
            />
            <button
              className="bg-orange-600 hover:bg-orange-500 text-white px-6 py-2 w-full font-semibold
           text-xl rounded-xl"
            >
              Send Message
            </button>
